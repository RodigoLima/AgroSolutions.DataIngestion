...
echo "  Grafana (DataIngestion):  http://localhost:30300 (admin/admin)"
echo "  Grafana (Identity):      http://localhost:30381 (admin/admin)"
echo "  Grafana (Property):      http://localhost:30380 (admin/admin)"
echo "  Grafana (Medicoes):      http://localhost:30000 (admin/admin)"
echo "  Prometheus:     http://localhost:30900 | 30902 (Medicoes) | 30980 | 30981"
